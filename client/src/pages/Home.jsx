  ...
  return (
    <div className="hero-container w-full mt-15">
      <div className="hero h-120 w-250 m-auto rounded-xl flex flex-col justify-center items-center">
        <div className="h-120 w-250 bg-[#0000009f] m-auto rounded-xl flex flex-col justify-center items-center">
      ...
      <div className="w-full m-auto flex flex-col justify-center items-center pb-50">
        <div className="text-left flex w-250 text-xl font-semibold mt-7.5">
          Why Choose <p>&nbsp;Verde<span className="text-[#098409]">X</span></p>?
        </div>
        <p className="w-250 text-left text-3xl font-extrabold mt-10">
          Verde<span className="text-[#098409]">X</span> offers a seamless and reliable
          <br />
        ...
        <div className="flex flex-row mt-10 justify-between w-250">
          <div className="flex flex-col justify-evenly h-45 border-2 border-gray-400 w-80 rounded-2xl">
            <p>
              <img src={time} alt="time" className="h-7 pl-3" />
            </p>
            <p className="pl-3 font-bold">Real-Time Trading</p>
          ...
          <div className="flex flex-col justify-evenly h-45 border-2 border-gray-400 w-80 rounded-2xl">
            ...
            <p className="pl-3 font-bold">Secure Transactions</p>
            <p className="pl-3 text-sm">
          ...
          <div className="flex flex-col justify-evenly h-45 border-2 border-gray-400 w-80 rounded-2xl">
            ...
            <p className="pl-3 font-bold">User-Friendly Interface</p>
            <p className="pl-3 text-sm">
